...
class Admin_Bar
{
    ...
    public function AdminMenu()
    {
        ...
        if (Capabilities::Check($capability)) {
            ...
            add_menu_page(__('Integrations for WordPress Forms', 'bit-integrations-pro'), __('Bit Integrations Pro', 'bit-integrations-pro'), $capability, 'bit-integrations', '', 'data:image/svg+xml;base64,' . base64_encode('<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            $submenu['bit-integrations'] = [
                [__('All Integrations', 'bit-integrations-pro'), $capability, 'admin.php?page=bit-integrations#/'],
                [__('Doc & Support', 'bit-integrations-pro'), $capability, 'admin.php?page=bit-integrations#/doc-support'],
                [__('Settings', 'bit-integrations-pro'), $capability, 'admin.php?page=bit-integrations#/app-settings'],
            ];
        }
    }
