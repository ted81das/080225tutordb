...
if ( ! class_exists( 'BbpCore_Install_Core' ) ) :
	...
	class BbpCore_Install_Core {
		...
		public function init_hooks() {
			...
			add_action( 'wp_ajax_BbpCore_Install_Core_installer', array( $this, 'install_bbp_core_core' ) );
		}
		 ...
		 * @return void
		 */
		public function install_bbp_core_core() {
			...
			$nx_status    = $this->install_plugin( 'bbp-core', 'bbp-core.php' );
