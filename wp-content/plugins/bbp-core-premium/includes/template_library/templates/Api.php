...
class Api extends Source_Base {
	...
	const LIBRARY_OPTION_KEY = 'bbpc_library_info';

	const LIBRARY_TIMESTAMP_CACHE_KEY = 'bbpc_remote_update_timestamp';
	const API_INFO_URL = 'https://wordpress-theme.spider-themes.net/elementor-template-library/bbp-core/';
	...
	public function get_title() {
		return esc_html__( 'BBP Core Library', 'bbp-core-pro' );
	}
	...
	public function save_item( $template_data ) {
		return new \WP_Error( 'invalid_request', 'Cannot save template to a BBP Core elementor library' );
	}
	
	public function update_item( $new_data ) {
		return new \WP_Error( 'invalid_request', 'Cannot update template to a BBP Core elementor library' );
	}

	
	public function delete_template( $template_id ) {
		return new \WP_Error( 'invalid_request', 'Cannot delete template from a BBP Core elementor library' );
	}

	public function export_template( $template_id ) {
		return new \WP_Error( 'invalid_request', 'Cannot export template from a BBP Core elementor library' );
	}
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		if ( empty( $data ) || empty( $data['content'] ) ) {
			throw new \Exception( __( 'Template does not have any content', 'bbp-core-pro' ) );
		}
